...
// Você foi contratado/a para fazer o sistema de cálculo de notas de uma escola. Crie uma função que receba 3 parâmetros: nota da primeira prova (`p1`),
//  nota da segunda prova (`p2`) e nota dos exercícios (`ex`).
...
// Se a média for maior ou igual a 9, retorne o conceito A (IF)
// Se a média for menor que nove e maior ou igual a 7.5, retorne B (ELSE IF)
// Se a média for menor que 7.5 e maior ou igual a 6, retorne C (ELSE IF)
// Se a média for menor que 6, retorne D (ELSE)
